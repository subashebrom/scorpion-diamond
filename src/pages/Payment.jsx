    ...
    return (
        <div className='w-full bg-primarybg md:bg-mainbg text-white/90 font-Ubuntu border-b border-b-gray-700 mt-10'>
            <section className='w-[90%] px-2 mx-auto pt-8  md:border-l md:border-l-gray-500 md:border-r md:border-r-gray-500 md:bg-gmbtnbg pb-8'>
                <div className='md:w-100 mx-auto border border-gray-500 bg-gmbtnbg p-2'>
                ...
                <div className='md:w-100 md:mx-auto border border-gray-500 bg-gmbtnbg p-2 mt-4 font-hind-siliguri grid gap-2.5'>
                ...
                <div className='flex md:w-full items-center justify-center mt-4'>
